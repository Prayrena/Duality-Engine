...
void Renderer::CreateImmediateVertexBuffer()
{
	...
	m_immediateVBO = CreateVertexBuffer(3, vertexSize, m_device);
}
...
void Renderer::BeginCamera(const XrCompositionLayerProjectionView& layerView, const XrSwapchainImageBaseHeader* swapchainImage, int64_t swapchainFormat)
{
